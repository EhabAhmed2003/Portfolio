...
const ThemeButton = () => {
	...
	return (
        ...
        transition-all duration-300
		  bg-primary hover:bg-primary/80 shadow-primary shadow-[0_0_2px_rgb(151,243,255)_inset,0_0_6px_rgb(151,243,255),0_0_15px_rgb(151,243,255)]
        `}
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					viewBox="0 0 512 512"
					className={`w-4 h-4 transition-all duration-300 fill-foreground`}
				>
