export const projectsData = [
	{
		id: 1,
		title: "projects.quran.title",
		desc: "projects.quran.description",
...

	{
		...
		desc: "projects.grocery.description",
		...
		features:
			"category sidebar, a homepage with popular products and categories, product listing and detail pages with related items, search functionality, responsive design, light & dark modes, and full Arabic/English support.",
	},
	{
		id: 3,
		title: "projects.movies.title",
		desc: "projects.movies.description",
